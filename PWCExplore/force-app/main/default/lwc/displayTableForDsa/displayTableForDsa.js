...
export default class DisplayTableForDSA extends LightningElement {
    originalData = [];
    dataBeingShown = [];
    columns = [];
    dataMap = new Map();
    ...
    */
    ...
    parseData() {
     ...
     // Function to create the data structure necessary for table pagination in non-mobile device.
    ...
    // Function to update the table data being displayed based on user action.
        paginate(event, newPageNumber, dataToBeShown) {        
        // Get the number of pages that will be needed to show the data.
